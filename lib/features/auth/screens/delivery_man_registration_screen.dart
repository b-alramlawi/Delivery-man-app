...
class _DeliveryManRegistrationScreenState extends State<DeliveryManRegistrationScreen> {
  ...
  void initState() {
    ...
    // Safely check if countryCode exists before accessing it
    if (splashProvider.configModel?.countryCode != null) {
    ...
    authProvider.setIdentityTypeIndex(authProvider.identityTypeList.isNotEmpty ? authProvider.identityTypeList[0] : "", false);
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<String>(
                                  value: authProvider.identityTypeList.isNotEmpty
                    ...
                    // simulate DashboardScreen button to test
                    TextButton(
                      ...
                      child: RichText(
                        text: TextSpan(children: [
                          TextSpan(
                            text: getTranslated('dashboard', context),
  ...
  void _addDeliveryMan() async {
    ...
    String numberWithCountryCode = _countryDialCode != null ? _countryDialCode! + phone : phone;
    ...
    if (fName.isEmpty) {
      ...
      authProvider.registerDeliveryMan(
